...
apt-get update && apt-get install -y git wget curl unzip build-essential cmake pkg-config libssl-dev libffi-dev libsndfile1 libportaudio2 portaudio19-dev python3-dev python3-pip python3-venv ffmpeg libsm6 libxext6 libxrender-dev libgomp1 libglib2.0-0 libgl1-mesa-glx libgtk-3-0 libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libxvidcore-dev libx264-dev libjpeg-dev libpng-dev libtiff-dev libatlas-base-dev gfortran libhdf5-dev libhdf5-103 python3-pyqt5 libgstreamer1.0-0 libgstreamer-plugins-base1.0-0 libgstreamer-plugins-bad1.0-0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav gstreamer1.0-tools gstreamer1.0-x gstreamer1.0-alsa gstreamer1.0-gl gstreamer1.0-gtk3 gstreamer1.0-qt5 gstreamer1.0-pulseaudio
